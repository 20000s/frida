// ke maybe use libart to jie kw so dlopen("libart.so") theno use classLOader to jie ke
    ...
    if(addr_DefineClass){
        Interceptor.attach(addr_DefineClass,{
            onEnter : function(args){
                ...
                var size = ptr(dex_file).add(Process.pointerSize + Process.pointerSize).readUInt();// i do not know why?
...
//为什么要hook dlopen hook android_dlopen_ext 后面几个都没看懂...
